...
const testimonials = [
  {
    ...
    content:
      "ساعدتنا خدمات المتسوق الجديد على تحسين تجربة العملاء بشكل كبير وزيادة معدلات الرضا لدى عملائنا. نتائج التقارير كانت دقيقة ومفصلة وساعدتنا على اتخاذ قرارات مهمة.",
  ...
  },
  {
    ...
    content:
      "تعاملنا مع المتسوق الجديد كان تجربة مميزة. الاحترافية العالية والدقة في العمل ساهمت في تطوير خدماتنا وتدريب موظفينا بشكل أفضل.",
    image: "/placeholder.svg?height=100&width=100",
    rating: 5,
  },
  {
    ...
    content:
      "التقارير التي قدمها فريق المتسوق الجديد ساعدتنا على اكتشاف نقاط الضعف في خدماتنا المصرفية وتحسينها. نتائج ملموسة وتوصيات قابلة للتطبيق.",
    image: "/placeholder.svg?height=100&width=100",
    rating: 4,
  },
]
